ddescribe('$modal', function () {
  ...
  //- pressing ESC on closed modals shouldn't break things
  //- same for click - need to unregister closing handlers
  //- think of a strategy where events for a modal (esc) are not consantly registered / unregistered
  //fading => got no idea what is going on here, but I should fade in / out only when backdrop is needed / not needed
  //- pressing ESC when there are no modals open doesn't break things
});